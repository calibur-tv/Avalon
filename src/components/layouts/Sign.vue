  ...
  <div id="space3D"
    ...
    <div class="sign-modal-wrap abs" ref="wrap">
      <div class="sign-modal sign-in-modal"
        ...
        <form class="form-container" v-show="showReset" data-vv-scope="reset">
          <div>
            <input name="access"
                   type="text"
        ...
        <form class="form-container" v-show="!showReset" data-vv-scope="sign-in">
          <div>
            <input name="access"
                   type="text"
                   v-validate="'required|email'"
      ...
      <div class="sign-modal sign-up-modal"
        ...
        <div class="form-container">
          <form class="form" data-vv-scope="sign-up">
            <div>
              <input type="text"
                     name="nickname"

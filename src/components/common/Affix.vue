...
export default {
  ...
  methods: {
    ...
    onScroll() {
      ...
      this.setDynamicVariables();
      if (
        this.affixHeight + this.offset.top >=
    ...
    handleAffix() {
      if (this.scrollAffix && this.affixHeight > window.innerHeight) {
        ...
        if (
          ...
          if (
            this.screenBottomPos >= this.affixBottomPos + this.offset.bottom &&
        ...
        if (
          ...
          if (
            this.distanceFromTop + this.offset.top + this.topPadding <
    ...
    setScrollAffixScrolling() {
      this.currentScrollAffix = "scrollaffix-scrolling";
      this.$el.style.top = `${this.affixRect.top +
        this.distanceFromTop -
        this.affixInitialTop}px`;
    ...
    setScrollAffixBottom() {
      this.currentScrollAffix = "scrollaffix-bottom";
      this.$el.style.top = `${this.relativeElmBottomPos -
        this.affixInitialTop -
        this.affixHeight}px`;
      this.$el.style.bottom = "auto";
      this.removeClasses();
      this.emitEvent();
    ...
    setAffixBottom() {
      ...
      this.$el.style.top = `${this.relativeElement.offsetHeight -
        this.affixHeight -
        this.offset.bottom -
        this.topPadding}px`;
      if (this.currentState !== this.lastState) {
